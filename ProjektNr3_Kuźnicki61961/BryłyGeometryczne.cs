...
using static ProjektNr3_Kuźnicki61961.LaboratoriumNr3;
...
namespace ProjektNr3_Kuźnicki61961
{
    public class BrylyGeometryczne
    {
        public abstract class BrylaAbstrakcyjna : IComparable<BrylaAbstrakcyjna>
        {
            ...
            public int CompareTo(BrylaAbstrakcyjna Bryla)
            {
                if (UchwytFormularza1.rdbWysokosc.Checked)
                {
                    if (this.WysokoscBG > Bryla.WysokoscBG) return 1;
                    else if (this.WysokoscBG < Bryla.WysokoscBG) return -1;
                    else return 0;
                }
                else if (UchwytFormularza1.rdbObjetosc.Checked)
                {
                    if (this.ObjetoscBryly > Bryla.ObjetoscBryly) return 1;
                    else if (this.ObjetoscBryly < Bryla.ObjetoscBryly) return -1;
                    else return 0;
                }
                else if (UchwytFormularza1.rdbPolePowierzchni.Checked)
                {
                    if (this.PowierzchniaBryly > Bryla.PowierzchniaBryly) return 1;
                    else if (this.PowierzchniaBryly < Bryla.PowierzchniaBryly) return -1;
                    else return 0;
                }
                else
                    return 0;
        ...
        public class Walec : BrylyObrotowe
        {
            ...
            // wektor przesunięcia wierzchołka Walca pochylonego
            int WektorPrzesunieciaSrodkaSufituWalca;
